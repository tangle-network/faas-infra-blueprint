...
exports.FunctionBuilder = exports.FaaSClient = exports.ClientMetrics = exports.ExecutionMode = exports.Runtime = void 0;
exports.run = run;
 ...
 * @public
 */
class FaaSClient extends events_1.EventEmitter {
    constructor(config) {
        super();
     ...
     * ```
     */
    async runJavaScript(code, options) {
        return this.execute({
     ...
     */
    async runTypeScript(code, options) {
        return this.execute({
     ...
     */
    async forkExecution(parentId, command, options) {
     ...
     */
    async createSnapshot(containerId, name, description) {
 ...
 */
async function run(code, language = 'python', baseUrl = 'http://localhost:8080') {
