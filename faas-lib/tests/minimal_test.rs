...
async fn test_minimal() -> Result<()> {
    ...
    let job = harness
        .submit_job(
            ...
            0,
            vec![
                InputValue::String(blueprint_sdk::tangle::serde::new_bounded_string(
                    "alpine:latest",
                )),
                InputValue::List(
                    blueprint_sdk::tangle::metadata::macros::ext::FieldType::String,
                    blueprint_sdk::tangle::serde::BoundedVec(vec![
                        InputValue::String(blueprint_sdk::tangle::serde::new_bounded_string(
                            "echo",
                        )),
                        InputValue::String(blueprint_sdk::tangle::serde::new_bounded_string(
                ...
                InputValue::List(
                    blueprint_sdk::tangle::metadata::macros::ext::FieldType::Uint8,
                    blueprint_sdk::tangle::serde::BoundedVec(vec![]),
                ),
            ],
        )
